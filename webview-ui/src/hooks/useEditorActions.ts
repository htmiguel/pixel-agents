...
export interface EditorActions {
  ...
  handleOpenAgent: (agentType: string, folderPath?: string) => void;
...
export function useEditorActions(
  ...
  const handleOpenAgent = useCallback((agentType: string, folderPath?: string) => {
    vscode.postMessage({ type: 'openAgent', agentType, folderPath });
  }, []);
